                                ...
                                <div class="card-body" >
                                     <form method="post">
		                                ...
		                                <input type="email" id="email" name="email" required >
                                         ...
                                         <br />
                                        <label id="savedEmail"></label>

                                         <br />
                                         <label for="phone">Mobile Phone:</label>
		                                <input type="text" id="phone" name="phone" >
                                         <br />
                                         <label id ="savedPhone"></label>
                                         <br />
                                         ...
                                         <script>
                                             ...
                                             function save() {
                                                 ...
                                                 document.getElementById("savedEmail").innerHTML = "Saved Email : " + Item;

                                                 var Item2 = document.getElementById("phone").value;
                                                 localStorage.setItem("storedItem2", Item2);
                                                 document.getElementById("savedPhone").innerHTML = "Saved phone number : " + Item2;
                                             }
                            
                                             function get() {
                                                 var Item =  localStorage.getItem("storedItem",Item);
                                                 document.getElementById("savedEmail").innerHTML = "Saved Email is : " + Item;

                                                 var Item2 = localStorage.getItem("storedItem2", Item2);
                                                 document.getElementById("savedPhone").innerHTML = "Saved phone number is : " + Item2;
                                             }
                                         </script>
