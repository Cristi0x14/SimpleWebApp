            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="project">
                        ...
                        <header>
                            <hr class="sidebar-divider d-none d-md-block">
                              <h1 style="text-align:center" class="h3 mb-0 text-gray-800">Portfolio</h1>
                             <hr class="sidebar-divider d-none d-md-block">
                        </header>
                        <body>
                            <div class="test">
                                ...
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Car Dealer Website</h6>
                                </div>
                                <div class="card-body">
                                     <img class="card-img" style="height: auto ;width: 80%" src="https://cardealer5.co.uk/news/wp-content/uploads/2018/11/mailshot800.jpg" alt=""/>
                                </div>
                                        <br />

                                        <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Online Fruit Shop</h6>
                                </div>
                                <div class="card-body">
                                     <img class="card-img" style="height: auto ;width: 80%" src="https://themewagon.com/wp-content/uploads/2020/03/tropika-1.jpg" alt=""/>
                                </div>
                            </div>
                            <div class="col-lg-6">
